...
import { globalHindiDictionary, globalMarathiDictionary } from './dictionaries';
...
const translations: Record<Language, Translation> = {
  ...
  hi: {
    ...
    dashboard: 'डैशबोर्ड', learningPlatform: 'लर्निंग प्लेटफॉर्म', resumeBuilder: 'रिज़्यूमे बिल्डर', opportunities: 'अवसर', notebookLLM: 'नोटबुक LLM', community: 'समुदाय', profile: 'प्रोफ़ाइल', standard: 'मानक', support: 'सहायता', assessmentScore: 'मूल्यांकन स्कोर', accessibilityMode: 'पहुंच मोड', active: 'सक्रिय', viewProgress: 'प्रगति देखें', resumeDescription: 'अपनी खूबियों के अनुसार पेशेवर, ATS-अनुकूल रिज़्यूमे बनाएं।', openResumeBuilder: 'रिज़्यूमे बिल्डर खोलें', aiNotebook: 'AI नोटबुक', smartLearningAssistant: 'स्मार्ट लर्निंग सहायक', connectWithPeers: 'साथियों से जुड़ें', jobsAndScholarships: 'नौकरियां और छात्रवृत्तियां', customiseExperience: 'अनुभव को अनुकूलित करें',
...
const dashboardHindiAdditional: Record<string, string> = {
  'Welcome back': 'वापस स्वागत है', 'Welcome Back!': 'वापस स्वागत है!',
  'Notebook LLM': 'नोटबुक LLM', 'Resume Builder': 'रिज़्यूमे बिल्डर',
  ...
  'Matched': 'मिलान किए गए', 'Applied': 'आवेदन किए गए', 'Resume Score': 'रिज़्यूमे स्कोर', 'Recommended Career Paths': 'अनुशंसित करियर पथ', 'Your Learning Roadmap': 'आपका सीखने का रोडमैप', 'Match score': 'मिलान स्कोर',
...
const dashboardMarathiAdditional: Record<string, string> = {
  'Welcome back': 'पुन्हा स्वागत आहे!', 'Welcome Back!': 'पुन्हा स्वागत आहे!',
  'Notebook LLM': 'नोटबुक LLM', 'Resume Builder': 'रेझ्युमे बिल्डर',
...
export function getDashboardTextTranslations(language: Language): Record<string, string> {
  return language === 'hi' ? { ...dashboardHindi, ...dashboardHindiAdditional, ...globalHindiDictionary } : language === 'mr' ? { ...dashboardMarathi, ...dashboardMarathiAdditional, ...globalMarathiDictionary } : {};
}
