    ...
    <div className="max-w-5xl mx-auto">
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-text">My Learning</h1>
        </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-surface rounded-xl p-6 text-center">
            ...
            <h4 className="font-bold text-text mb-2">Adaptive Content</h4>
          ...
          <div className="bg-surface rounded-xl p-6 text-center">
            ...
            <h4 className="font-bold text-text mb-2">Targeted Support</h4>
            <p className="text-text-muted text-sm">
          ...
          <div className="bg-surface rounded-xl p-6 text-center">
            ...
            <h4 className="font-bold text-text mb-2">Progress Tracking</h4>
            <p className="text-text-muted text-sm">
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-3">
          ...
          <h4 className="font-bold text-lg text-text">Coming Soon</h4>
        </div>
