  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col items-start gap-4 mb-12">
        ...
        <p className="text-text-muted text-lg font-medium max-w-2xl leading-relaxed mt-2">
      ...
      >
        ...
        <motion.div 
          ...
          className="bg-surface rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow group"
        >
          ...
          <h3 className="text-text text-xl font-bold mb-4">
            Adaptive UI
          </h3>
          <p className="text-text-muted font-medium leading-relaxed text-sm">
            Instantly switch to dyslexia-friendly modes.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-text-muted font-medium leading-relaxed text-sm">
            Learn by listening, speaking, or reading.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-text-muted font-medium leading-relaxed text-sm">
            Keep your attention sharp without feeling overwhelmed.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-text-muted font-medium leading-relaxed text-sm">
            Get matched to inclusive employers based on your skills.
          </p>
        </motion.div>
