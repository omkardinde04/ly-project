...
export function Q3ObjectNaming() {
  return (
    <svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <rect width="400" height="220" fill="#f0f7ff" rx="16" />
      {/* Central object silhouette - simple lamp shape */}
...
export function Q11SoundSegmentation() {
  return (
    <svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <rect width="400" height="220" fill="#f0f7ff" rx="16" />
      {/* Segmented shape: 3 connected parts */}
      ...
      {/* Sound wave under each segment */}
      {[85, 200, 315].map((cx, i) => (
        <g key={i}>
          <path d={`M${cx - 18},165 Q${cx - 9},150 ${cx},165 Q${cx + 9},180 ${cx + 18},165`}
...
export function Q15ReadingAloud() {
  return (
    <svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <rect width="400" height="220" fill="#f0f7ff" rx="16" />
      {/* Sound waves - evenly spaced, calm */}
      {/* Center line */}
      <line x1="50" y1="110" x2="350" y2="110" stroke="#e0f2fe" strokeWidth="1.5" />
      {/* Wave arcs - 5 pairs, evenly spaced with gaps (pause dots between) */}
      {[0, 1, 2, 3, 4].map((i) => {
        const cx = 70 + i * 62;
        return (
          <g key={i}>
